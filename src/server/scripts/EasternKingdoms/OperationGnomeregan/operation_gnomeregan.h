...
Position const iInfantrySpawn[26] =
{
...
Position const iSoldierSpawn[5] =
{
...
Position const InfantrySpawn[19] =
{
...
Position const BattleSuitDriverSpawn[3] =
{
...
Position const BattleSuitSpawn[6] =
{
...
Position const BomberSpawn              = {-5314.53f, 564.82f, 391.43f, 5.7f};
Position const RadControlSpawn          = {-5072.80f, 441.48f, 410.97f, 2.6f};

Position const TroggSpawn               = {-5181.74f, 631.21f, 398.54f, 4.7f};

Position const ExplosionBunnySpawn      = {-5183.24f, 608.97f, 410.89f, 4.7f};
