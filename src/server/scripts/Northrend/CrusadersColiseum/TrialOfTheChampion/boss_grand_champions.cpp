    ...
    struct boss_warrior_toc5AI : public BossAI
    {
        ...
        void UpdateAI(uint32 uiDiff) override
        {
            if (!bDone && GrandChampionsOutVehicle(me))
            {
                ...
                if (me->GetGUID() == pInstance->GetGuidData(DATA_GRAND_CHAMPION_1))
                    me->SetHomePosition(739.678f,662.541f,413.395f,4.49f);
				else if (me->GetGUID() == pInstance->GetGuidData(DATA_GRAND_CHAMPION_2))
                    me->SetHomePosition(746.71f,661.02f,412.695f,4.6f);
				else if (me->GetGUID() == pInstance->GetGuidData(DATA_GRAND_CHAMPION_3))
