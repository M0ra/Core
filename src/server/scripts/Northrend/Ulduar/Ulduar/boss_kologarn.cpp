...
class spell_kologarn_focused_eyebeam_damage : public SpellScriptLoader
{
public:
    spell_kologarn_focused_eyebeam_damage() : SpellScriptLoader("spell_kologarn_focused_eyebeam_damage") { }

    class spell_kologarn_focused_eyebeam_damage_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_kologarn_focused_eyebeam_damage_SpellScript);
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(spell_kologarn_focused_eyebeam_damage_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCHOOL_DAMAGE);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_kologarn_focused_eyebeam_damage_SpellScript();
    }
};
